<div>
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-600">Modifica la información del cliente</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <form wire:submit="update">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Info Usuario Online -->
                    @if($customer->hasUser())
                    <div class="md:col-span-2 bg-primary-50 border border-primary-200 rounded-lg p-4">
                        <div class="flex items-center">
                            <i class="fas fa-globe text-primary-600 text-2xl mr-3"></i>
                            <div>
                                <p class="font-semibold text-primary-900">Este cliente tiene acceso online</p>
                                <p class="text-sm text-primary-700">Email registrado: {{ $customer->user->email }}</p>
                            </div>
                        </div>
                    </div>
                    @endif
