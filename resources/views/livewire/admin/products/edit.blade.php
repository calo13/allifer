        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 flex items-center">
                    <div
                        class="w-12 h-12 bg-gradient-to-br from-blue-500 to-primary-600 rounded-xl flex items-center justify-center mr-4 shadow-lg">
                ...
                <p class="mt-2 ml-16 text-sm text-gray-600">
                    ...
                    Actualiza la información de <strong>{{ $product->name }}</strong>
                </p>
            </div>
            <a href="{{ route('admin.products.index') }}"
                class="inline-flex items-center px-4 py-2 bg-white border-2 border-gray-200 hover:border-blue-500 text-gray-700 hover:text-blue-600 rounded-xl shadow-sm hover:shadow-md transition-all duration-200">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-center mb-6">
                        <div
                            class="w-10 h-10 bg-gradient-to-br from-blue-500 to-primary-600 rounded-lg flex items-center justify-center mr-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fas fa-barcode text-primary-500 mr-1"></i>SKU
                            </label>
                            <input type="text" wire:model="sku" placeholder="PROD-00001"
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="barcode" placeholder="7501055301120"
                                class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition-all">
                            @error('barcode')
                            <span class="text-red-500 text-xs flex items-center mt-1">
                                <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                    ...
                    <div class="mt-4">
                        ...
                        <textarea wire:model="description" rows="3" placeholder="Detalles adicionales del producto..."
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span
                                    class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 font-medium">Q</span>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span
                                    class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 font-medium">Q</span>
                                <input type="number" step="0.01" wire:model="precio_mayorista"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <div
                                class="w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-gray-100 text-gray-600 font-medium">
                        ...
                        <div>
                            ...
                            <p class="mt-1.5 text-xs text-gray-500 flex items-center">
                                <i class="fas fa-bell text-yellow-400 mr-1"></i>Alerta cuando el stock esté bajo
                            </p>
                            @error('stock_minimo')
                            <span class="text-red-500 text-xs flex items-center mt-1">
                                <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        <div class="flex items-center mb-4">
                            <div
                                class="w-8 h-8 bg-gradient-to-br from-amber-500 to-orange-600 rounded-lg flex items-center justify-center mr-2">
                        ...
                        <div class="space-y-2 mb-4 max-h-64 overflow-y-auto pr-1">
                            ...
                            <div
                                class="bg-gradient-to-r from-gray-50 to-white border border-gray-200 rounded-lg p-3 hover:shadow-sm transition-shadow">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <span
                                                class="text-xs text-gray-500 uppercase tracking-wide">{{ $variant['type'] }}</span>
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <p
                                                class="font-medium {{ ($variant['precio_adicional'] ?? 0) > 0 ? 'text-green-600' : 'text-gray-400' }}">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <p
                                                class="font-medium {{ ($variant['stock'] ?? 0) > 0 ? 'text-blue-600' : 'text-red-500' }}">
                                                {{ $variant['stock'] ?? 0 }} uds
                                            </p>
                                        </div>
                                        @endif
                        ...
                        <div class="bg-primary-50 border border-primary-200 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model="newVariantPrice" placeholder="0.00"
                                        step="0.01"
                                        class="w-full text-sm rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-200">
                                </div>
                                <!-- Stock (solo si es por variante) -->
                                <div>
            ...
            <div class="space-y-6">
                ...
                <div
                    ...
                    <div class="flex items-center mb-4">
                        <div
                            class="w-10 h-10 bg-gradient-to-br from-pink-500 to-rose-600 rounded-lg flex items-center justify-center mr-3">
                    ...
                    <div class="mb-6">
                        <label class="block text-xs font-medium text-gray-700 mb-2">Imagen Principal</label>

                        <!-- 1. Si hay nueva imagen subida (PREVIEW) -->
                        @if ($image)
                        <div class="relative w-full h-48 rounded-lg overflow-hidden ring-2 ring-green-500 shadow-md">
                            <img src="{{ $image->temporaryUrl() }}" class="w-full h-full object-cover">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end justify-center pb-2">
                                <span class="text-white text-xs font-bold bg-green-500 px-2 py-1 rounded-full shadow-sm">
                                    <i class="fas fa-check mr-1"></i>Nueva Imagen
                                </span>
                            </div>
                            <button type="button" wire:click="$set('image', null)"
                                class="absolute top-2 right-2 bg-red-500 hover:bg-red-600 text-white w-8 h-8 rounded-full flex items-center justify-center shadow-md transition-transform hover:scale-110">
                                <i class="fas fa-times"></i>
                            </button>
                        </div>

                        <!-- 2. Si NO hay nueva imagen, mostrar la existente -->
                        @elseif ($product->image)
                        <div class="relative group w-full h-48 rounded-lg overflow-hidden ring-1 ring-gray-200">
                            <img src="{{ Storage::url($product->image) }}" class="w-full h-full object-cover">
                            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                <span class="text-white text-xs font-medium bg-black/50 px-3 py-1 rounded-full">Imagen Actual</span>
                            </div>
                        </div>

                        <!-- 3. Si no hay ninguna -->
                        @else
                        <div class="w-full h-48 bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center text-gray-400">
                            <i class="fas fa-image text-3xl mb-2"></i>
                            <span class="text-xs">Sin imagen asignada</span>
                        </div>
                        @endif

                        <!-- Botón de subida (Siempre visible) -->
                        <div class="mt-3">
                            <label class="flex items-center justify-center w-full px-4 py-2 bg-white border border-gray-300 rounded-lg shadow-sm cursor-pointer hover:bg-gray-50 hover:border-primary-400 transition-all group">
                                <i class="fas fa-camera text-gray-500 group-hover:text-primary-600 mr-2"></i>
                                <span class="text-xs font-medium text-gray-700 group-hover:text-primary-600">
                                    {{ $image || $product->image ? 'Cambiar Imagen' : 'Subir Imagen' }}
                                </span>
                    ...
                    <!-- AREA DE IMÁGENES ADICIONALES -->
                    <div class="mb-4 pt-4 border-t border-gray-100">
                        <label class="block text-xs font-medium text-gray-700 mb-2">Imágenes Adicionales</label>

                        <div class="grid grid-cols-3 gap-2 mb-3">
                            <!-- Existentes -->
                            @foreach ($existingImages as $img)
                            <div class="relative group aspect-square rounded-lg overflow-hidden ring-1 ring-gray-200">
                            ...
                            <div class="relative group aspect-square rounded-lg overflow-hidden ring-2 ring-purple-400">
                            ...
                            <!-- Botón agregar más -->
                            <label class="flex flex-col items-center justify-center aspect-square border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-purple-50 hover:border-purple-400 transition-all">
                                <i class="fas fa-plus text-purple-400 mb-1"></i>
                                <span class="text-[10px] text-gray-500 text-center leading-tight">Agregar<br>Más</span>
                ...
                <div
                    ...
                    <div class="flex items-center mb-4">
                        <div
                            class="w-10 h-10 bg-gradient-to-br from-purple-500 to-primary-600 rounded-lg flex items-center justify-center mr-3">
                    ...
                    <div class="space-y-3">
                        <button type="submit"
                            class="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-primary-600 hover:from-blue-700 hover:to-primary-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
